...
│   │       └── (other paths)
│   │
│   ├── audit/                           # For internal/IT/security audit team
│   │   ├── threat-model.md              # STRIDE/DREAD analysis
│   │   └── logs-policy.md               # Log retention, PII rules, audit logs
│   │
│   └── guides/                          # Developer-focused guides
│       ├── setup-env.md                 # How to run services locally
│       ├── project-structure.md
│       └── conventions.md
│
├── pkg/                       # Shared, reusable libraries
│   ├── go.mod                 # Module bitka/pkg
│   ├── config/                # Shared config loader (env → struct)
│   │   └── config.go
